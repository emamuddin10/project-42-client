...
//                 <button
//                   type="submit"
//                   className="w-full px-4 py-2 font-semibold text-white bg-green-600 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
//                 >
//                   Register
//                 </button>
//               </div>
