...
const PremiumApproval = () => {
    ...
    const fetchRequests = async () => {
        try {
            const { data } = await axios.get('https://project-42-server.onrender.com/premium-requests');
            setRequests(data);
        } catch (error) {
    ...
    const approveRequest = async (requestId) => {
        try {
            const { data } = await axios.patch(`https://project-42-server.onrender.com/premium-requests/approve/${requestId}`);
