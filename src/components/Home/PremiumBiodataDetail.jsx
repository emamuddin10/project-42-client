...
const PremiumBiodataDetail = () => {
  ...
  return (
    ...
    <div className="container mx-auto p-6">
      <h2 className="text-center text-4xl font-bold font-serif  mb-10">
        {" "}
        Premium BioData Details
      </h2>
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-2/3 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p>
                  <strong>Date:</strong> {biodata.biodata.date}
                </p>
                <p>
                  <strong>Height:</strong> {biodata.biodata.height}
                </p>
                <p>
                  <strong>Weight:</strong> {biodata.biodata.weight}
                </p>
                <p>
                  <strong>Age:</strong> {biodata.biodata.age}
                </p>
              </div>
              <div>
                <p>
                  <strong>Occupation:</strong> {biodata.biodata.occupation}
                </p>
                <p>
                  <strong>Race:</strong> {biodata.biodata.race}
                </p>
                <p>
                  <strong>Father's Name:</strong> {biodata.biodata.fName}
                </p>
                <p>
                  <strong>Mother's Name:</strong> {biodata.biodata.mName}
                </p>
              </div>
              <div>
                <p>
                  <strong>Permanent Division:</strong>{" "}
                  {biodata.biodata.permanentDivision}
                </p>
                <p>
                  <strong>Present Division:</strong>{" "}
                  {biodata.biodata.presentDivision}
                </p>
              </div>
              <div>
                <p>
                  <strong>Partner's Age:</strong> {biodata.biodata.partnerAge}
                </p>
                <p>
                  <strong>Partner's Height:</strong>{" "}
                  {biodata.biodata.partnerHeight}
                </p>
                <p>
                  <strong>Partner's Weight:</strong>{" "}
                  {biodata.biodata.partnerWeight}
                </p>
                {isPremium && (
                  <div>
                    <p>
                    ...
                    <p>
                      <strong>Phone Number:</strong> {biodata.biodata.number}
                    </p>
                  </div>
                )}
              </div>
