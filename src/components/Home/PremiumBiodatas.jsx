...
const PremiumBiodatas = () => {
  ...
  return (
    <div className='mt-14'>
      <h2 className='text-center font-bold text-4xl text-black font-serif mb-3'>Premium Biodatas</h2>
            ...
            <div className="p-3">
              <div className="space-y-3">
                ...
                <div className="px-6 pt-4 pb-2">
                  <button className="bg-green-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => handleViewDetails(biodata._id)}>
                    View Details
                  </button>
                </div>
              </div>
